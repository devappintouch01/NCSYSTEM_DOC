...
- [PRINT FORM](https://drive.google.com/drive/u/1/folders/1sEE7MFRQSwhtctGj4HeZR6RJy4-Bp_zd)
  - [4.8 - ยส.1](https://drive.google.com/drive/u/1/folders/1OhsWuFucpH8RWCmplOcpEhK77GWIM6k2)
    ...
    - [คำขอ ยส.1-1 DOCX](DOCX_ยส.1-1.docx)
...
<ul>
  <li>ค้นหาจาก
    <ul>
      ...
      <!-- <br> -  -->
      <br> - ใช้ API GetLicense (api/License/Narcotic/Search) <br> - ทำเป็น Dropdown แสดงรายการใบอนุญาต ยส.1 <br> - แสดงข้อมูล ชื่อย่อใบอนุญาต, เลขที่ใบอนุญาต [ตัวอย่าง นยส1 กท 1/2569] <br> - แสดงเฉพาะใบอนุญาตที่ยังไม่หมดอายุ</li>
      หรือ
