...
| วัตถุประสงค์/ประเภทการขอ | 1. ขอใหม่ | 2. ขอเพิ่มสาร (เพิ่มชนิด) | 3. ขอเพิ่มปริมาณ | 4. ขอต่อเนื่อง <br> คค. เท่าเดิม | 5. ขอต่อเนื่อง <br> คค. มากกว่าปริมาณเดิม | 6. ขอต่ออายุ |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| 1. เพื่อประโยชน์ของทางราชการในการป้องกันและปราบปรามการกระทำความผิดเกี่ยวกับยาเสพติดหรือความร่วมมือระหว่างประเทศ กรณีจำเป็นเร่งด่วน                     | ✅ | ✅ | ✅ | ✅ | ✅ | ไม่มีขอต่ออายุ |
| 2. เพื่อการศึกษาและวิจัย                             | ✅ | ✅ | ✅ | ไม่มีขอต่อเนื่อง | ไม่มีขอต่อเนื่อง | ไม่มีขอต่ออายุ |
| 3. เพื่อประโยชน์ทางการแพทย์                        | ✅ | ✅ | ✅ | ✅ | ✅ | ไม่มีขอต่ออายุ |
| 4. เพื่อประโยชน์ทางวิทยาศาสตร์                       | ✅ | ✅ | ✅ | ✅ | ✅ | ไม่มีขอต่ออายุ |
| 5. เพื่อประโยชน์ทางอุตสาหกรรม **ภายใต้ระบบปิด**     | ✅ | ✅ | ✅ | ✅ | ✅ | ไม่มีขอต่ออายุ |
| 6. เพื่อประโยชน์ทางอุตสาหกรรม **ไม่อยู่ภายใต้ระบบปิด** | ✅ | ✅ | ✅ | ✅ | ✅ | ไม่มีขอต่ออายุ |
...
| วัตถุประสงค์ (Objective) / <br> สาร | ประเภทสาร (NarcoticTypeId) | เงื่อนไขสาร <br> ([dbo].[MasterNarcoticEster]) | เงื่อนไขหน่วย (MasterNarcoticUnit) |
|---|:---:|:---:|:---:|
| 7. เพื่อใช้เป็นสารมาตรฐานในการตรวจวิเคราะห์ <br> เฉพาะ หน่วยงานของรัฐที่เป็นนิติบุคคล| 4 | ยาเสพติดให้โทษในประเภท 4 ทุกชนิด | - |
...
| 3 | วันที่ยื่น | `Requisition`.`SubmitDate` |  |
| 4 | วันที่รับ | `Requisition`.`ReceiveDate` |  |
| 5 | วันที่อนุมัติ | `License`.`IssueDate` |  |
| 6 | วันที่อนุมัติ | `License`.`ExpireDate` |  |
| 7 | ส่งกลับมาภายในวันที่ | `Requisition`.`OverAllDueDate` |  |
