...
| วัตถุประสงค์ (Objective)/การดำเนินการ(Operation) | ผลิต (Produce) | ผลิตเพื่อส่งออก (Produce for Export) | นำเข้า (Import) | ส่งออก (Export) |
|---|---|---|---|---|
...
|---|---|
| (วัตถุประสงค์ Objective) 1.2 การบริหารยาเสพติดให้โทษในประเภท 2 <br> หรือ วัตถุออกฤทธิ์ในประเภท 2 ที่ใช้ในทางการแพทย์ของประเทศ | - Show on **every** Operation (ผลิต, ผลิตเพื่อส่งออก, นำเข้า, ส่งออก) <br> - |
| (วัตถุประสงค์ Objective) 1.2 การผลิตเพื่อส่งออก | - Show on **every** Operation (ผลิต, ผลิตเพื่อส่งออก, นำเข้า, ส่งออก) <br> - |
| (การดำเนินการ Operation) 1.3 ขอส่งออก | - Show only Operation **ส่งออก (Export)** <br> - Show on **every** Objective |
